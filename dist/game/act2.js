...
export const ACT2_EXIT = {
    x: 69,
    // Выход находится в кладовой второго этажа. Раньше здесь была высота
    // первого этажа, поэтому проверка взгляда отбрасывала дверь и кнопка E
    // после получения ключа вообще не появлялась.
    y: FLOOR2_Y + 1.4,
    z: 1.2,
    standZ: 2.4,
    name: "Кладовая второго этажа · служебный выход",
};
...
export function objectiveFor(stage, hasLaptop) {
    switch (stage) {
        ...
        case "escape":
            return "Служебный выход в кладовой второго этажа — удерживайте E";
        default:
...
export function makeCaptcha(difficulty = "normal") {
